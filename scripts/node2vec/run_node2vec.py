...
def process_file(args):
    MAIN_FILE, OUTPUT_ROOT, fpath,dim,walk_len,n_walks,roar = args
    ...
    if not roar:
        ...
        return f'activate "BMMB && python {MAIN_FILE} --input {fpath} --output {outfpath} --dimensions {dim} --directed --walk-length {walk_len} --num-walks {n_walks}"'
